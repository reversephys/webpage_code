        ...
        return (
            <main className="min-h-screen bg-background pt-32 pb-20 px-6 font-serif flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 mb-6">You don't have permission to view this notice.</p>
                    <Link href="/notice" className="underline underline-offset-4">Return to Notices</Link>
                </div>
            </main>
        );
    }
